...
code = code.replace(
  ...
  "className={`w-full bg-white/[0.03] backdrop-blur-2xl border border-white/10 rounded-3xl overflow-hidden shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] ${isFullscreen ? 'fixed inset-0 z-50 p-4 bg-black w-screen h-screen' : ''}`}"
);
